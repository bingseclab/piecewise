...
public:
  ...
  virtual MCSymbol *getCurrentFunc() { }
  virtual void setCurrentFunc(MCSymbol *Func) { }
  virtual void addCGEdge(MCSymbol *Caller, MCSymbol *Callee) { }
  virtual void addCodePtr(MCSymbol *F) { }
  virtual void printCG() { }
  virtual void printCodePtr() { }
