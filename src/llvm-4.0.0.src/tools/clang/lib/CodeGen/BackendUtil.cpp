...
void EmitAssemblyHelper::CreatePasses(legacy::PassManager &MPM,
  ...
  PMBuilder.PwiseMode = CodeGenOpts.getPwiseInfo();
...
void EmitAssemblyHelper::CreateTargetMachine(bool MustCreateTM) {
  ...
  //Read CodeGenOpts to TargetOpts
  switch(CodeGenOpts.getPwiseInfo()) {
    case CodeGenOptions::PwiseMode::FullScan:
      Options.PwiseMode = llvm::PwiseModeKind::FullScan;
      break;
    case CodeGenOptions::PwiseMode::LocalScan:
      Options.PwiseMode = llvm::PwiseModeKind::LocalScan;
      break;
    case CodeGenOptions::PwiseMode::PtAnalysis:
      Options.PwiseMode = llvm::PwiseModeKind::PtAnalysis;
      break;  
  }
